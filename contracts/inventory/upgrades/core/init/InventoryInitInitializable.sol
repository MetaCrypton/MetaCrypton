...
contract InventoryInitInitializable is IInitializable, Initializable, InventoryStorage {
    ...
    function _storeMethods(address upgradeAddress) internal {
        ...
        _methods[IInventoryStaticMethods(address(0x00)).getERC20s_.selector] = upgradeAddress;
        _methods[IInventoryStaticMethods(address(0x00)).getERC20Balance_.selector] = upgradeAddress;
        ...
        _methods[IInventoryStaticMethods(address(0x00)).getERC721s_.selector] = upgradeAddress;
        _methods[IInventoryStaticMethods(address(0x00)).isERC721Owner_.selector] = upgradeAddress;
