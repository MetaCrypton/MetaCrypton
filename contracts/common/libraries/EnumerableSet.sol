...
/**
 * @author OpenZeppelin
 * Original Copyright (c) 2016-2020 zOS Global Limited
 * Mofified Copyright Anton "BaldyAsh" Grigorev.
...
library EnumerableSet {
    ...
    */
    ...
    /**
    * @return the number of values on the set. O(1)
    */
    ...
    /**
    * @return the value stored at position `index` in the set. O(1)
    * @param index Item identifier in set. Must be strictly less than {length}.
    */
    ...
    */
    ...
    /**
    * @return the number of values in the set. O(1)
    */
    ...
    */
    function values(AddressSet storage set) internal view returns (address[] memory) {
        uint len = set._inner._values.length;
        
        address[] memory list = new address[](len);
        for (uint i = 0; i < len; i++) {
            list[i] = address(uint160(uint(set._inner._values[i])));
        }
        return list;
    }
    ...
    */
    function values(UintSet storage set) internal view returns (uint[] memory) {
        ...
        for (uint i = 0; i < len; i++) {
            list[i] = uint(set._inner._values[i]);
        }
        return list;
    }
